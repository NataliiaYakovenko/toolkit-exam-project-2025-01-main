...
const validationSchema = {
  ...
  EventSchema: yup.object().shape({
    eventName: yup
      .string()
      .min(3, 'The event name must contain at least 3 symbols')
    ...
    notificationTime: yup
      ...
      .max(1440, 'The notification time must not be more 24 hours')
      .integer('The notification time must be an integer')
      .required('The notification time is required'),
  }),
};
